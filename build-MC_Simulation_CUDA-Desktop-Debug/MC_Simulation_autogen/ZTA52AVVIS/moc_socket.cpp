...
QT_MOC_LITERAL(1, 7, 11), // "sendResults"
...
QT_MOC_LITERAL(7, 62, 17), // "requestParameters"
QT_MOC_LITERAL(8, 80, 12) // "requestBatch"

    },
    "socket\0sendResults\0\0disconnected\0"
    "bytesWritten\0bytes\0readyRead\0"
    "requestParameters\0requestBatch"
};
...
void socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendResults(); break;
        case 1: _t->disconnected(); break;
        case 2: _t->bytesWritten((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 3: _t->readyRead(); break;
        case 4: _t->requestParameters(); break;
        case 5: _t->requestBatch(); break;
        default: ;
        }
    }
}
