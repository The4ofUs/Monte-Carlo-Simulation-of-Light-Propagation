...
QT_MOC_LITERAL(4, 46, 14), // "displayCounter"
QT_MOC_LITERAL(5, 61, 13), // "newConnection"
QT_MOC_LITERAL(6, 75, 23) // "on_listenButton_clicked"

    },
    "serverSide\0startServer\0\0on_pushButton_clicked\0"
    "displayCounter\0newConnection\0"
...
void serverSide::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        serverSide *_t = static_cast<serverSide *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->startServer(); break;
        case 2: _t->displayCounter(); break;
...
const QMetaObject serverSide::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_serverSide.data,
      qt_meta_data_serverSide,  qt_static_metacall, nullptr, nullptr}
};
