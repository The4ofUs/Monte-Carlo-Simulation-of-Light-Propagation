...
std::vector<float> coefficients1 = {0.18f, 0.16f, 0.04f,0.66f};
std::vector<float> coefficients2 = {19.f, 16.f, 2.4f, 110.5f};
std::vector<float> refractive_indices = {1.4f, 1.4f, 1.331f, 1.450f};
