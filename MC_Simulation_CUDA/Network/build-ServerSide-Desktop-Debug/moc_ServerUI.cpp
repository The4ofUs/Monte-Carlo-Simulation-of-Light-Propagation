...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ServerUI_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ServerUI_t qt_meta_stringdata_ServerUI = {
    {
QT_MOC_LITERAL(0, 0, 8), // "ServerUI"
QT_MOC_LITERAL(1, 9, 23), // "on_listenButton_clicked"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "ServerUI\0on_listenButton_clicked\0"
};
...
const QMetaObject ServerUI::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ServerUI.data,
      qt_meta_data_ServerUI,  qt_static_metacall, nullptr, nullptr}
};
...
void *ServerUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ServerUI.stringdata0))
