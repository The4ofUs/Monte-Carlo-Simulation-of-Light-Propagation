...
Tissue::Tissue(float radius, Point c0, Point c1, float absorbCoeff, float scatterCoeff)
{
    this->_radius = radius;
    this->_center0 = c0;
    this->_center1 = c1;
...
bool Tissue::escaped(Point position)
{
    Point A = position;
...
void Tissue::attenuate(Photon &photon)
{
